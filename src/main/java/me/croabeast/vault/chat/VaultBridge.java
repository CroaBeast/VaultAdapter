...
final class VaultBridge extends net.milkbowl.vault.chat.Chat {

    private final ChatProvider backend;

    VaultBridge(ChatProvider backend) {
    ...
    private static final class PermissionDelegate extends net.milkbowl.vault.permission.Permission {
