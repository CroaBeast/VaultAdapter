...
final class ProviderVault2 implements PermissionProvider {

    private final Permission source;
    private final Plugin plugin;

    ProviderVault2(Permission source, Plugin plugin) {
    ...
    public String toString() {
        return "PermissionProvider{provider='VaultUnlocked', plugin='" + source.getName() + "'}";
    }
}
